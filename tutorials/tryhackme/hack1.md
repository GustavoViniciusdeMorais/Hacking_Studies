...
docker cp Downloads/MetasploitWordlist.txt kali:/home

apt install iputils-ping -y # ping -c 3 192.168.0.1

apt install iproute2 -y # ss -ntulp

apt install netcat-openbsd -y # nc -lvnp 4444
